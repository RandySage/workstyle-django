var newTagTemplate = "{{ MEDIA_URL }}/ajp/TagListNewTag.html";
var tagTypeListTemplate = "{{ MEDIA_URL }}/ajp/TagListTagTypeList.html";

var newTagTypeTemplate = "{{ MEDIA_URL }}/ajp/TagTypeListNewTagType.html";

var tagListTemplate = "{{ MEDIA_URL }}/ajp/TaskDetailTagList.html";
var tagSelecterTemplate = "{{ MEDIA_URL }}/ajp/TaskDetailTagSelecter.html";
var commentListTemplate = "{{ MEDIA_URL }}/ajp/TaskDetailCommentList.html";
var linkedTaskListTemplate = "{{ MEDIA_URL }}/ajp/TaskDetailLinkedTaskList.html";
var linkedTaskTagSelecterTemplate = "{{ MEDIA_URL }}/ajp/TaskDetailLinkedTaskTagSelecter.html";
/**
